...
def main():
    ...
    # save the prediction
    os.makedirs("./intermediate_output/stacking2nd_lgbm", exist_ok=True)
    path_to = "./intermediate_output/stacking2nd_lgbm/pred_test.pkl"
    with open(path_to, "wb") as f:
        pickle.dump(sub, f)
    path_to = "./intermediate_output/stacking2nd_lgbm/pred_valid.pkl"
    with open(path_to, "wb") as f:
