...
def get_args():
    ...
    parser.add_argument(
        "--inputs", help="for ensembling. can be recursively nested for averaging."
    )
    parser.add_argument("--output", required=True)
    parser.add_argument(
        "--sample_submission", default="./input/stage_2_sample_submission.csv"
    )
...
def avg_predictions(results):
    ...
    return {"ids": results[0]["ids"], "outputs": outputs}
