workdir = "./intermediate_output/se_resnext101_mixup"
seed = 20
apex = True
...
model = dict(name="se_resnext101_32x4d", pretrained="imagenet", n_output=6)

scheduler = dict(name="MultiStepLR", params=dict(milestones=[1, 2, 4], gamma=2 / 3))
