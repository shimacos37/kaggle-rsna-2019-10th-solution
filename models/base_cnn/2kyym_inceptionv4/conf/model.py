workdir = "./intermediate_output/2kyym_inceptionv4"
seed = 20
apex = True

n_fold = 5
epoch = 5
# resume_from = "./model/model002/fold0_ep2.pt"
resume_from = None
...
model = dict(name="inceptionv4", pretrained="imagenet", n_output=6)

scheduler = dict(name="MultiStepLR", params=dict(milestones=[1, 2, 3], gamma=2 / 3))
