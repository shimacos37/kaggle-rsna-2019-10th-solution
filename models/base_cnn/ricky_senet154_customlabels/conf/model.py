...
data = dict(
    train=dict(
        ...
        annotations="./intermediate_output/preprocessed_data/train_folds_senet154_customlabels.pkl",
    ...
    test=dict(
        dataset_type="CustomDataset",
        annotations="./intermediate_output/preprocessed_data/test_senet154_customlabels.pkl",
